...
<head>
    ...
    <title>MenTal(k) - Login Dokter</title>
    <style type="text/css">
        .btn {
            border-radius: 20px;
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title" align="center">MASUK SEBAGAI DOKTER</h5>
                        <div class="row">
                            <div class="col-md-6 col-sm-12 sidebar">
                                <form action="checklogin_dokter.php" method="post">
                            ...
                            <div class="col-md-6 col-sm-12 content">
                                <img class="img-fluid" src="img/logindokter.png" alt="Responsive image"
