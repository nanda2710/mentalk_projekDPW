                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 sidebar">
                                <form action="changepassword-pasien.php" method="POST">
                                    <div class="form-row">
...
<?php
    ...
    $sql = mysql_query ("SELECT password FROM pasien WHERE password ='$password_lama'");
    $hasil = mysql_num_rows ($sql);
    if (! $hasil > 0) {
        ?>
            <script language="JavaScript">
            alert('Password lama tidak sesuai!, silahkan ulang kembali!');
            document.location='hangepassword-pasien.php';
            </script>
        <?php
            unset($_SESSION['user']);
            session_destroy();
    ...
    //validasi data data kosong
        ...
        ?>
            ...
            document.location='changepassword-pasien.php';
            </script>
        <?php   
    }
    ...
    //update data
    $query = "UPDATE pasien SET password='$password_baru' WHERE username='$username'";
