            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="artikel1.php" class="btn btn-outline-info">Baca lebih lanjut</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Pada tahun 2016, Indonesia kembali menjadi sorotan dunia, namun dengan
                                ...
                                Indonesia.</p>
                            <a href="artikel2.php" class="btn btn-outline-info">Baca lebih lanjut</a>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="artikel3.php" class="btn btn-outline-info">Baca lebih lanjut</a>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="artikel4.php" class="btn btn-outline-info">Baca lebih lanjut</a>
                        </div>
                    </div>
                </div>
            </div>
